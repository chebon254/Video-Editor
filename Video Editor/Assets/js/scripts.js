...
var recording = navigator.mediaDevices.getDisplayMedia({
	...
	function getInputValue(){
		...
		var inputVal = document.getElementById("videoName").value;
		// Fetch the anchor tag
		var showCase = document.querySelector('.download-anc').setAttribute("download", inputVal+ ".mp4");
	}